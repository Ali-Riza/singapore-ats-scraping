...
COMPANY_URL = "https://sg.jobstreet.com/rtp-company-singapore-pte-ltd-jobs/at-this-company"
CAREERS_URL = COMPANY_URL
SOURCE_NAME = "rtp-company"
...
def main():
    print("RTP Company  ->  Singapore (JobStreet)", flush=True)
