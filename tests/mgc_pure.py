...
COMPANY_URL = "https://sg.jobstreet.com/MGC-Pure-Chemicals-Singapore-Pte-Ltd-jobs/at-this-company"
CAREERS_URL = COMPANY_URL
SOURCE_NAME = "mgc-pure"
...
def main():
    print("MGC Pure  ->  Singapore (JobStreet)", flush=True)
