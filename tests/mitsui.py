...
COMPANY_URL = "https://sg.jobstreet.com/Mitsui-Chemicals-Group-jobs/at-this-company"
CAREERS_URL = COMPANY_URL
SOURCE_NAME = "mitsui-chemicals-group"
...
def main():
    print("Mitsui Chemicals Group  ->  Singapore (JobStreet)", flush=True)
